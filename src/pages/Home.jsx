...
export const Home = ({ onDownload }) => {
  return (
    <div className="space-y-10 sm:space-y-12 pb-16 animate-fade-in font-sans">
      
      {/* 1. Calm Editorial Hero with Digital Shelf */}
      <Hero onDownload={onDownload} />

      {/* 2. Quick Intro Strip */}
      <section className="border-y border-[#E1E6E2] bg-[#EAF1EC]/40 py-4">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
          ...
          <Link
            to="/about"
            className="text-xs font-semibold text-[#5B9C8D] hover:underline flex items-center gap-1 shrink-0"
          >
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 pb-3 border-b border-[#E1E6E2]">
          <div>
            <span className="text-[11px] font-semibold text-[#5B9C8D] uppercase tracking-wider block mb-0.5">
              ARCHIVE CATALOG
            </span>
          ...
          <Link
            to="/apps"
            className="inline-flex items-center gap-1 text-xs font-bold text-[#5B9C8D] hover:underline transition-colors"
          >
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
        <div className="flex items-center justify-between pb-3 border-b border-[#E1E6E2]">
          ...
          <Link
            to="/collections"
            className="text-xs font-semibold text-[#5B9C8D] hover:underline flex items-center gap-1"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {COLLECTIONS_DATA.slice(0, 2).map((col) => (
            <Link
              key={col.id}
              to="/collections"
              className="bg-white rounded-2xl border border-[#E1E6E2] p-5 shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-0.5 block group"
            >
              ...
              <h3 className="text-base font-bold text-[#202522] mt-2.5 group-hover:text-[#5B9C8D] transition-colors font-sans">
                {col.name}
              </h3>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 text-center pt-2 pb-4">
        <div className="bg-white rounded-2xl border border-[#E1E6E2] p-6 sm:p-8 shadow-sm space-y-3">
          <span className="text-[11px] font-bold text-[#5B9C8D] tracking-widest uppercase block">
            BUILDING PHILOSOPHY
          </span>
          <blockquote className="text-base sm:text-xl font-bold text-[#202522] leading-relaxed font-sans">
